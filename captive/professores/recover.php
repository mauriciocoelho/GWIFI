<?php  
	...
	{
	 header("location:http://wifi.itpacporto.com.br/captive/professores/forgot.php");
	}
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post" action="update.php">
					...
					<div class="text-center p-t-12">
						...
						<a class="txt2" href="http://wifi.itpacporto.com.br/captive/professores/portal.html">
							voltar
						</a>
					</div>
