<?php             
  require_once ("../../config/database_acad.php");
    ...
    <tr>
      ...
      <td width="80" style="text-align:center">
        ...
        <a href="#" class="pencil" data-toggle="modal" data-target="#ModalEdit" 
          ...
          data-whatevername="<?php echo $row['name']; ?>"
          data-whateverusername="<?php echo $row['username']; ?>"
          data-whateverop="<?php echo $row['op']; ?>"
          data-whatevercpf="<?php echo $row['cpf']; ?>"><em class="fa fa-pencil" style="color: #1E90FF"></em></a>
        <!-- Botão Deletar -->
        <a href="#" class="trash" data-toggle="modal" data-target="#ModalDelete<?php echo $row['id']; ?>"><em class="fa fa-trash"></em></a></div>
        <!-- Modal Deletar -->
        <?php include_once('modal/delete.php'); ?>
        <!-- Fim Modal Deletar -->
      </tr>    
  </tbody>
  <?php } ?>
