<!-- Modal -->
<form id="add-row-form" action="views/academicos/crud/add.php" method="post">
    	...
    	<div class="modal-dialog" role="document">
      		<div class="modal-content">
        		<div class="modal-header">
            		...
            		<h4 class="modal-title">Cadastrar Acadêmico</h4>
        		</div>
        		<div class="modal-body">
		        	<div class="form-group">
		          	...
		          	<div class="form-group">
		            	<input type="text" name="username" id="username-input" class="form-control" placeholder="Usuário (CPF)" required>
		          	</div>
			          	<div class="form-group">
		            	<input type="text" name="dtnascimento" id="dtnascimento-input" class="form-control" placeholder="Data de Nascimento" required>
		          	</div>	
		          	<div class="form-group">
