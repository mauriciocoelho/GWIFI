      ...
      <tr>
        ...
        <td width="80" style="text-align:center">
          ...
          <a href="#" class="pencil" data-toggle="modal" data-target="#ModalEdit" 
            ...
            data-whateverdtnascimento="<?php echo date("d/m/Y", strtotime($row['dtnascimento'])); ?>"><em class="fa fa-pencil" style="color: #1E90FF"></em></a>
          <!-- Botão Deletar -->
          <a href="#" class="trash" data-toggle="modal" data-target="#ModalDelete<?php echo $id; ?>"><em class="fa fa-trash"></em></a></div>
          <!-- Modal Deletar -->
          <?php include('../../views/professores/modal/delete.php'); ?>
          <!-- Fim Modal Deletar -->                              
        </td>
      </tr>    
    </tbody>
